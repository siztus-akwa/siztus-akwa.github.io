                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">Study at your own<br> convenience</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                <h3>View all available modules with ease</h3>
                                <p>The automated process for your study needs.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                <h3>Know your program advisors</h3>
                                <p>Get to know the program advisors for your courses.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                <h3>Reschedule your modules</h3>
                                <p>Busy at the moment? not a problem.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="team-active">
                    <div class="single-cat text-center">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Bindu Jose</a></h5>
                        </div>
                    </div>
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Julie Mayers</a></h5>
                        </div>
                    </div>
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Nigel Houlden</a></h5>
                        </div>
                    </div>
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Jessica Muirhead</a></h5>
                        </div>
                    </div>
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Denise Oram</a></h5>
                        </div>
                    </div>
                </div>
            </div>
